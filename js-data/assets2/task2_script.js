(() => {
    ...
    let pictures = [{
            id: 1,
            data: false,
            text: 'Треугольник расположен между прямоугольником и кругом.'
        },
        {
            id: 2,
            data: false,
        ...
        },
        {
            id: 3,
            data: true,
            text: 'Прямоугольник расположен слева от треугольника.'
        },
        {
            id: 4,
            data: true,
            text: 'Треугольник расположен между прямоугольником и овалом.'
        }
    ]
